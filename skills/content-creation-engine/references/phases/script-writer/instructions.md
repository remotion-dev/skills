...
| `humor-and-punch-up.md` | Any TOFU/MOFU piece, any short-form hook, or any request for "funny," "personality," "less generic," or "use your imagination." The comedic technique toolkit + the Step 6.5 punch-up process + the screenshot-test rubric. |
| `swipe-file.md` | Skim before writing any creative/short-form piece, to anchor on real examples Graeham flagged as landing. The single highest-leverage anti-generic input. |
