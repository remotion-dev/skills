...
<div class="cal-integrate">
  <strong>&#x1F4C5; Calendar Integration:</strong> This topic is the anchor for its scheduled day. If a higher-priority breaking story arrives, options: <strong>(A)</strong> Replace this slot with the breaking topic. <strong>(B)</strong> Add as Sat/Sun interrupt. <strong>(C)</strong> Re-score on the next ideation pass. <a href="./online-content/dashboards/weekly-calendars/">&rarr; Current weekly calendar</a>
</div>
