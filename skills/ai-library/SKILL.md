---
name: ai-library
description: Personal AI Library — Graeham's private cross-reference combining Pantana's AI Marketing Academy library (72 items: 22 bots, 29 prompts, 20 guides, 1 video), 20 community prompts from Prompt Studio, 12 lectures, 9 lessons, 45 Personal Claude Skills with diagrams and how-to-use blocks, and 2 Personal Custom Prompts (Language Tutor, Humanizer). 398-page PDF + interactive HTML with 49 inline SVG diagrams. PRIVATE — do not share publicly. Use ANY time the user asks about AiM, AI Marketing Academy, Pantana, Jason Pantana, the library, BOFU library, AEO library, "what does AiM say about X", "find a prompt for X", "which of my skills cover X", cross-reference my skills with AiM, library item, what skills do I have for [topic], what's in the AI library, look up [Pantana bot/prompt/guide name]. Also trigger when user mentions implementation plan, gaps to build, schema-builder gap, llm-listing-engine gap. Source of truth at C:\\Users\\Graeham Watts\\Documents\\Claude\\AI-Library\\ (mirrors private repo github.com/Graehamwatts/ai-library).
---
