...
**Repo:** `online-content`  
**Branch:** `main`  
**Path pattern:** `cmas/CMA_[address].html`  
**Hosted URL pattern:** `https://graehamwatts.github.io/online-content/cmas/CMA_[address].html`
...
result, error = run_composio_tool(
    ...
    arguments={
        ...
        'upserts': [{'path': 'cmas/CMA_[address].html', 'content': html_content, 'encoding': 'utf-8'}]
    },
    account='github_spar-devata'
)
```
