...
```
https://graehamwatts.github.io/online-content/cmas/CMA_[address].html?v=2
```
...
4. Navigate to `https://github.com/Graehamwatts/online-content/edit/main/CMA_[address].html` (or `/new/main?filename=...` for new files)
