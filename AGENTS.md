# READ THIS FIRST — Onboarding for Codex sessions touching this repo
...
- `.Codex-plugin/` — Cowork plugin manifest.
- `.nojekyll` — disables Jekyll on GitHub Pages.
- `index.html` + `assets/` — GitHub Pages landing page.
- `AGENTS.md` (this file) — onboarding.
